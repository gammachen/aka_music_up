...
- [ sidebar bk 0707](_sidebar_bk_0707.md)
- [ sidebar bk 0708](_sidebar_bk_0708.md)
- [ sidebar bk 0709](_sidebar_bk_0709.md)
- [ sidebar bk 0716](_sidebar_bk_0716.md)
...
- Bigdata
  ...
  - [22 sqoop flume](bigdata/22_sqoop_flume.md)
  - [23 数据分层](bigdata/23_数据分层.md)
  - [24 指标 维度 度量 V2](bigdata/24_指标-维度-度量-v2.md)
  - [24 指标 维度 度量](bigdata/24_指标-维度-度量.md)
  - [25 kylin](bigdata/25_kylin.md)
  - [25 kylin compare](bigdata/25_kylin_compare.md)
...
- Crawler
  - [2025 about crawler](crawler/2025_about_crawler.md)
  - [Firecrawl firecrawl](crawler/Firecrawl_firecrawl.md)
  - [README 关于Firecrawl Curl1 about firecrawl curl 1](crawler/README_关于Firecrawl_Curl1_about_firecrawl_curl_1.md)
  - [README 关于Firecrawl Curl2 about firecralw curl 2](crawler/README_关于Firecrawl_Curl2_about_firecralw_curl_2.md)
  - [README 关于Ollama LightRAG about ollama lightrag](crawler/README_关于Ollama_LightRAG_about_ollama_lightrag.md)
  - [T t](crawler/T_t.md)
  - [Firecrawl](crawler/firecrawl.md)
  - [绝对领域临时 jueduilingyu tmp](crawler/绝对领域临时_jueduilingyu_tmp.md)
...
- Kg
  - [01 知识图谱 架构与功能设计](kg/01_知识图谱_架构与功能设计.md)
  - [01 知识图谱 混合模式](kg/01_知识图谱_混合模式.md)
  - [01 知识图谱之知识表示与建模](kg/01_知识图谱之知识表示与建模.md)
  - [02 知识图谱之知识表示 XML RDF OWL](kg/02_知识图谱之知识表示_XML_RDF_OWL.md)
  - [03 知识图谱之知识表示 工具包](kg/03_知识图谱之知识表示_工具包.md)
  - [04 知识图谱之知识表示 OWL推理](kg/04_知识图谱之知识表示_OWL推理.md)
  - [04 知识图谱之知识表示 OWL推理 进阶](kg/04_知识图谱之知识表示_OWL推理_进阶.md)
  - [04 知识图谱之知识表示 企业 ERP](kg/04_知识图谱之知识表示_企业_ERP.md)
  - [04 知识图谱之知识表示 企业 经营分析](kg/04_知识图谱之知识表示_企业_经营分析.md)
  - [04 知识图谱之知识表示 推理原理](kg/04_知识图谱之知识表示_推理原理.md)
  - [04 知识图谱之知识表示 科研论文推导](kg/04_知识图谱之知识表示_科研论文推导.md)
  - [05 知识抽取 DB R2RML ontop](kg/05_知识抽取_DB_R2RML_ontop.md)
  - [05 知识抽取 分类 关系类型 ACE](kg/05_知识抽取_分类_关系类型_ACE.md)
  - [05 知识抽取 结构化数据](kg/05_知识抽取_结构化数据.md)
  - [05 知识抽取 网页数据](kg/05_知识抽取_网页数据.md)
  - [05 知识抽取 网页数据抓取工具集](kg/05_知识抽取_网页数据抓取工具集.md)
  - [05 知识抽取 网页数据抓取工具集 firecrawl](kg/05_知识抽取_网页数据抓取工具集_firecrawl.md)
  - [06 实体抽取 命名实体分类](kg/06_实体抽取_命名实体分类.md)
  - [06 实体抽取 命名实体抽取 方法](kg/06_实体抽取_命名实体抽取_方法.md)
  - [06 实体抽取 命名实体标注工作](kg/06_实体抽取_命名实体标注工作.md)
  - [06 实体抽取 命名实体识别 时间部分](kg/06_实体抽取_命名实体识别-时间部分.md)
  - [06 实体抽取 命名实体识别选择方案](kg/06_实体抽取_命名实体识别选择方案.md)
  - [06 实体抽取 命名实体识别难点](kg/06_实体抽取_命名实体识别难点.md)
  - [06 实体抽取 技术方案详解 V2](kg/06_实体抽取_技术方案详解-v2.md)
  - [06 实体抽取 技术方案详解](kg/06_实体抽取_技术方案详解.md)
  - [07 实体抽取 关系提取](kg/07_实体抽取_关系提取.md)
  - [08 语义标注 事件提取](kg/08_语义标注_事件提取.md)
  - [09 实体消岐 候选 排序](kg/09_实体消岐_候选_排序.md)
  - [09 实体消岐 候选 排序 2](kg/09_实体消岐_候选_排序_2.md)
  - [10 Neo4j 应用](kg/10_Neo4j_应用.md)
  - [10 知识规则挖掘](kg/10_知识规则挖掘.md)
  - [10 知识规则挖掘 大语言模型 混合架构](kg/10_知识规则挖掘_大语言模型_混合架构.md)
  - [11 基于关联规则的挖掘](kg/11_基于关联规则的挖掘.md)
  - [11 基于统计关系的挖掘](kg/11_基于统计关系的挖掘.md)
  - [12 图存储 现有成熟的DB](kg/12_图存储_现有成熟的DB.md)
  - [12 图存储概要](kg/12_图存储概要.md)
  - [13 知识融合](kg/13_知识融合.md)
  - [13 知识融合 实体对齐](kg/13_知识融合_实体对齐.md)
  - [13 知识融合 开源工具](kg/13_知识融合_开源工具.md)
  - [13 知识融合 案例](kg/13_知识融合_案例.md)
  - [14 知识检索 Cypher](kg/14_知识检索_Cypher.md)
  - [14 知识检索 基于查询语言](kg/14_知识检索_基于查询语言.md)
  - [15 企业员工画像图谱建设框架 Step1](kg/15_企业员工画像图谱建设框架-Step1.md)
  - [15 企业员工画像图谱建设框架 Step2](kg/15_企业员工画像图谱建设框架-Step2.md)
  - [15 企业员工画像图谱建设框架 新华书店](kg/15_企业员工画像图谱建设框架_新华书店.md)
  - [15 企业员工画像图谱建设框架 新华书店 价值应用](kg/15_企业员工画像图谱建设框架_新华书店_价值应用.md)
  - [15 企业员工画像图谱建设框架 新华书店 补充](kg/15_企业员工画像图谱建设框架_新华书店_补充.md)
  - [15 企业员工画像图谱建设框架 阿里巴巴](kg/15_企业员工画像图谱建设框架_阿里巴巴.md)
  - [16 Neo4j FunctionCall Help](kg/16_Neo4j_FunctionCall_Help.md)
  - [16 Neo4j TestFunction](kg/16_Neo4j_TestFunction.md)
  - [16 Neo4j UDF](kg/16_Neo4j_UDF.md)
  - [17 社交网络 营销推荐 Enhance](kg/17_社交网络_营销推荐-Enhance.md)
  - [17 社交网络 营销推荐](kg/17_社交网络_营销推荐.md)
  - [17 社交网络 营销推荐 重构](kg/17_社交网络_营销推荐_重构.md)
  - [18 电商 图数据应用](kg/18_电商_图数据应用.md)
  - [19 项目管理图架构](kg/19_项目管理图架构.md)
  - [19 项目管理图架构 关系人](kg/19_项目管理图架构_关系人.md)
  - [20 美食商城 ES Query关键处理 Enhance](kg/20_美食商城_ES_Query关键处理-Enhance.md)
  - [20 美食商城 ES Query关键处理 原则](kg/20_美食商城_ES_Query关键处理-原则.md)
  - [20 美食商城 ES Query关键处理](kg/20_美食商城_ES_Query关键处理.md)
  - [20 美食商城 LLM Query拆解](kg/20_美食商城_LLM_Query拆解.md)
  - [20 美食商城 LLM 检索增强 搜索重排](kg/20_美食商城_LLM_检索增强_搜索重排.md)
  - [20 美食商城 LLM 语义搜索增强](kg/20_美食商城_LLM_语义搜索增强.md)
  - [20 美食商城 Query LLM之前](kg/20_美食商城_Query_LLM之前.md)
  - [20 美食商城 数据初始化](kg/20_美食商城_数据初始化.md)
  - [20 美食商城 模型设计](kg/20_美食商城_模型设计.md)
  - [20 美食商城 订单关系设计](kg/20_美食商城_订单关系设计.md)
  - [20 美食商城 订单状态机](kg/20_美食商城_订单状态机.md)
  - [20 美食商城 订单状态设计](kg/20_美食商城_订单状态设计.md)
  - [20 美食商城 订单状态设计 Extend](kg/20_美食商城_订单状态设计_Extend.md)
  - [20 美食商城 阶段一 ES搜索支持](kg/20_美食商城_阶段一_ES搜索支持.md)
  - [20 美食商城 隐式关系与显示关系](kg/20_美食商城_隐式关系与显示关系.md)
  - [20 美食商城技术架构](kg/20_美食商城技术架构.md)
  - [21 医美项目 个性化推荐](kg/21_医美项目_个性化推荐.md)
  - [21 医美项目 医师匹配 机构推荐](kg/21_医美项目_医师匹配_机构推荐.md)
  - [21 医美项目基础架构](kg/21_医美项目基础架构.md)
  - [21 美食商城 ES 向量检索构建](kg/21_美食商城_ES_向量检索构建.md)
  - [22 KG Neo4j Usage](kg/22_KG-neo4j-usage.md)
  - [22 KG neo4j fuzzy search](kg/22_KG_neo4j_fuzzy_search.md)
  - [22 KG neo4j geo](kg/22_KG_neo4j_geo.md)
  - [22 供应商管理 架构设计](kg/22_供应商管理_架构设计.md)
  - [22 供应商管理 风险预警](kg/22_供应商管理_风险预警.md)
  - [24 KG backup neo4j](kg/24_KG_backup_neo4j.md)
  - [44 sync neo4j data](kg/44_sync_neo4j_data.md)
  - [README](kg/README.md)
...
- Micro service pro
  ...
  - [37 渠道库存](micro_service_pro/37_渠道库存.md)
  - [38 时间换空间 空间换时间](micro_service_pro/38_时间换空间_空间换时间.md)

```bash
scriptreplay record_py_watch_allocate_memory_time.txt record_py_watch_allocate_memory_time.txt
scriptreplay record_py_watch_swap_time.txt record_py_watch_swap.txt
scriptreplay record_py_watch_slabtop_time.txt record_py_watch_slabtop.txt
scriptreplay record_top_time.txt record_top_swap.txt
scriptreplay record_vmstat_time.txt record_vmstat_swap.txt
```


```bash
# script -t 2>record_py_watch_swap_time.txt -a record_py_watch_swap_time.txt
script -t 2>record_py_watch_allocate_memory_time.txt record_py_watch_allocate_memory_time.txt
...
```bash
script -t 2>record_py_watch_swap_time.txt record_py_watch_swap.txt
...
```bash
script -t 2>record_py_watch_slabtop_time.txt record_py_watch_slabtop.txt
sudo watch -n 1 "slabtop -o"

script -t 2>record_top_time.txt record_top_swap.txt
top


script -t 2>record_vmstat_time.txt record_vmstat_swap.txt
vmstat -t 1 1000
...
```bash
Every 1.0s: free -h && grep -i 'swap' /proc/meminfo                                                                                                                        shaofu: Thu Apr 24 11:14:50 2025

               total        used        free      shared  buff/cache   available
内存：      7.6Gi       378Mi       7.0Gi        34Mi       243Mi       7.0Gi
交换：      2.0Gi       273Mi       1.7Gi
SwapCached:         9328 kB
SwapTotal:       2097148 kB
SwapFree:        1817156 kB
Zswap:                 0 kB
...
```bash
asciinema rec record_py_watch_swap.cast
asciinema rec record_py_watch_slabtop.cast
asciinema rec record_top_swap.cast
asciinema rec record_vmstat_swap.cast

record_py_watch_slabtop.cast  record_py_watch_swap.cast  record_top_swap.cast  record_vmstat_swap.cast

scp shaofu@192.168.31.96:/home/shaofu/record_py_watch_slabtop.cast shaofu@192.168.31.96:/home/shaofu/record_py_watch_swap.cast shaofu@192.168.31.96:/home/shaofu/record_top_swap.cast shaofu@192.168.31.96:/home/shaofu/record_vmstat_swap.cast .
```
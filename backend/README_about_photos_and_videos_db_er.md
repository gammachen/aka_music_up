...
--------+---------------------------+-------+----------
 ...
 public | assets_audit              | table | postgres
 public | audit                     | table | postgres
 public | exif                      | table | postgres
 public | face_search               | table | postgres
 public | geodata_places            | table | postgres
 ...
 public | naturalearth_countries    | table | postgres
 public | partners                  | table | postgres
 public | partners_audit            | table | postgres
 public | person                    | table | postgres
 public | session_sync_checkpoints  | table | postgres
 public | sessions                  | table | postgres
 public | shared_link__asset        | table | postgres
 public | shared_links              | table | postgres
 public | smart_search              | table | postgres
 public | socket_io_attachments     | table | postgres
 ...
 public | users_audit               | table | postgres
...
--
-- Name: naturalearth_countries_tmp_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: socket_io_attachments_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.socket_io_attachments_id_seq OWNER TO postgres;

--
-- Name: socket_io_attachments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: socket_io_attachments id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: system_config PK_aab69295b445016f56731f4d535; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.system_config
    ADD CONSTRAINT "PK_aab69295b445016f56731f4d535" PRIMARY KEY (key);
...
--
-- Name: geodata_places geodata_places_tmp_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.geodata_places
    ADD CONSTRAINT geodata_places_tmp_pkey PRIMARY KEY (id) WITH (fillfactor='100');


--
-- Name: naturalearth_countries naturalearth_countries_tmp_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.naturalearth_countries
    ADD CONSTRAINT naturalearth_countries_tmp_pkey PRIMARY KEY (id) WITH (fillfactor='100');
...
--
-- Name: socket_io_attachments socket_io_attachments_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_geodata_gist_earthcoord_54793fe0_8c7d_4214_86fa_a26c8251d60; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_geodata_gist_earthcoord_54793fe0_8c7d_4214_86fa_a26c8251d60 ON public.geodata_places USING gist (public.ll_to_earth_public(latitude, longitude)) WITH (fillfactor='100');


--
-- Name: idx_geodata_places_admin2_name_0cf95b1e_757c_4eca_84a9_4943a618; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_geodata_places_admin2_name_0cf95b1e_757c_4eca_84a9_4943a618 ON public.geodata_places USING gin (public.f_unaccent(("admin2Name")::text) public.gin_trgm_ops);


--
-- Name: idx_geodata_places_country_code_026084da_dcc6_45a3_9d65_cbf2811; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_geodata_places_country_code_026084da_dcc6_45a3_9d65_cbf2811 ON public.geodata_places USING gin (public.f_unaccent((name)::text) public.gin_trgm_ops);


--
-- Name: idx_geodata_places_country_code_6d8bdd41_7145_4616_90bf_19dfaf7; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_geodata_places_country_code_6d8bdd41_7145_4616_90bf_19dfaf7 ON public.geodata_places USING gin (public.f_unaccent(("admin1Name")::text) public.gin_trgm_ops);
